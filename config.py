def load_parameters():
    ...
    #DATA_ROOT_PATH = '/media/HDD_2TB/DATASETS/%s/%s/joint_bpe' % (TASK_NAME, SRC_LAN+TRG_LAN)  # Path where data is stored
    ...
    MAX_INPUT_WORD_LEN = 15                        # Maximum length of each word in the input sequence. Meaningful for character NMT. Set to 0 otherwise (the whole words will be used)
