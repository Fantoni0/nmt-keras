...
class TranslationModel(Model_Wrapper):
    ...
    def Transformer(self, params):
        ...
        if params['TARGET_TEXT_EMBEDDING_SIZE'] == params['SOURCE_TEXT_EMBEDDING_SIZE']:
            max_len = max(params['MAX_INPUT_TEXT_LEN'], params['MAX_OUTPUT_TEXT_LEN'],
        ...
        src_residual_multihead = Add(name='add_src_embedding_positional_src_embedding')(
            [src_embedding, positional_src_embedding])
        ...
        for n_block in range(params['N_LAYERS_ENCODER']):
            ...
            # Add
            src_multihead = Add(name='src_Residual_MultiHeadAttention_' + str(n_block))(
                [src_multihead, prev_src_residual_multihead])

            # And norm
            src_multihead = BatchNormalization(mode=1, name='src_Normalization_MultiHeadAttention_' + str(n_block))(
                src_multihead)
        ...
        for n_block in range(params['N_LAYERS_DECODER']):
            ...
            shared_src_trg_multihead_norm = BatchNormalization(mode=1,
                                                               name='src_trg_Normalization_MultiHeadAttention_' + str(
                                                                   n_block))
            ...
            shared_ff_src_trg_multihead = TimeDistributed(PositionwiseFeedForwardDense(params['FF_SIZE'],
                                                                                       name='src_trg_PositionwiseFeedForward_' + str(
                                                                                           n_block)),
                                                          name='src_trg_TimeDistributedPositionwiseFeedForward_' + str(
                                                              n_block))
            ...
            ff_src_trg_multihead_add = shared_ff_src_trg_multihead_add(
                [ff_src_trg_multihead_dropout, src_trg_multihead_norm])
        ...
        for n_block in range(params['N_LAYERS_DECODER']):
            ...
            src_trg_multihead_add = shared_src_trg_add_multihead_list[n_block](
                [src_trg_multihead_dropout, trg_multihead_norm])
